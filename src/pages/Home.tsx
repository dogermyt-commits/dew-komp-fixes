  ...
  return (
    <div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center mb-12">Przykładowe usługi</h2>
      ...
      <section className="py-20 bg-gradient-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-4">Gotowy na naprawę?</h2>
          <p className="text-lg mb-8 opacity-90 max-w-2xl mx-auto">
            Skontaktuj się z nami i poznaj szczegóły naszej oferty. Chętnie odpowiemy na wszystkie pytania.
          </p>
